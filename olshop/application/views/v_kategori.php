                     ...
                     foreach($kategori as $key => $value) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button data-toggle="modal" data-target="#delete<?= $value->id_kategori ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></button>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
            ...
            <div class="modal-body">
              <?php echo form_open('kategori/add') ?>
                  <div class="form-group">
                    ...
                    <input type="text" name="nama_kategori" class="form-control" placeholder="Category" required>
                  </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <?php echo form_open('kategori/edit/'.$value->id_kategori) ?>
                  <div class="form-group">
                    <label>Category</label>
                    <input type="text" name="nama_kategori" value="<?= $value->nama_kategori ?>" class="form-control" placeholder="Category" required>
                  </div>
...
<?php foreach($kategori as $key => $value) { ?>
      <div class="modal fade" id="delete<?= $value->id_kategori ?>">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h2 class="modal-title">Delete <?= $value->nama_kategori ?></h2>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
