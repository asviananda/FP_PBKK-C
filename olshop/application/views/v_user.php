                     ...
                     foreach($user as $key => $value) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button data-toggle="modal" data-target="#delete<?= $value->id_user ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></button>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
            ...
            <div class="modal-body">
              <?php echo form_open('user/add') ?>
                  <div class="form-group">
                    <label>Name</label>
                    <input type="text" name="nama_user" class="form-control" placeholder="Name" required>
                  </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <?php echo form_open('user/edit/'.$value->id_user) ?>
                  <div class="form-group">
                    <label>Name</label>
                    <input type="text" name="nama_user" value="<?= $value->nama_user ?>" class="form-control" placeholder="Name" required>
                  </div>
...
<?php foreach($user as $key => $value) { ?>
      <div class="modal fade" id="delete<?= $value->id_user ?>">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h2 class="modal-title">Delete <?= $value->nama_user ?></h2>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
